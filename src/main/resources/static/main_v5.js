...
addUserForm.addEventListener('submit', (e) => {
    ...
    let username = addNewUserForm.find('#addUsername').val().trim();
...
on(document, 'click', '.btnEdit', e => {
    ...
    $('#usernameEdit').val(usernameEditForm);
...
editModalForm.addEventListener('submit', async (e) => {
    ...
    document.getElementById('username' + idEditForm).innerHTML = data.username;
    document.getElementById('roles' + idEditForm).innerHTML = data.roles.map(role => role.name).join(" ");
    editModal.hide()
})
